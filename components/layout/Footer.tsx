...
export default function Footer() {
  return (
    <footer className="bg-sand-900 text-sand-400 pt-16 pb-8 px-4">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 bg-sand-800 hover:bg-sand-700 rounded-lg flex items-center justify-center transition-colors cursor-pointer"
              >
        ...
        <div className="border-t border-sand-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-3">
